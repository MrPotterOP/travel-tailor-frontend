...
const FoundersSection = () => {
    ...
    const bgShapeOpacity = useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [0, 0.04, 0.04, 0]); // Fade in near start, fade out near end
    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                style={{ y: bgShapeY, opacity: bgShapeOpacity, top: '10%', left: '-10%' }}
             />
            <motion.div
                className={`${styles.bgShape} ${styles.bgShape2}`}
                 style={{ y: bgShapeY, opacity: bgShapeOpacity, bottom: '5%', right: '-15%' }}
            />
            ...
            <div className={styles.profilesContainer}>
                ...
                <motion.div className={`${styles.profileItem} ${styles.amanProfile}`} variants={itemVariants}>
                 ...
                 <motion.div className={`${styles.profileItem} ${styles.armaniProfile}`} variants={itemVariants}>
                     <div className={styles.textContainer}>
                        <h3 className={styles.name}>Kanishka</h3>
                        <p className={styles.quote}>For me, the magic lies in crafting the flow.</p>
                        <p className={styles.bio}>
                             Honed at places like Urban Company in Delhi, her expertise in operations and product is all about anticipating needs and perfecting the details. She&apos;s the curator of your experience, ensuring that from the moment you book until you&apos;re back home, every touchpoint feels intuitive, effortless, and tailored <em>just for you</em>. She turns logistics into moments of delight.
                        </p>
                    </div>
                     <motion.div className={styles.imageContainer} variants={imageWrapperVariants} >
                        <Image
