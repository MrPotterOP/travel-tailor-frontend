        ...
        <nav className={styles.navbar}>
            <div className={styles.navBox}>
                <div className={styles.navLogo}>
                    <Link href="/">
                        <Image src="/images/logo.png" alt="Travel Tailor Logo" width={100} height={50} />
                    </Link>
                </div>
                ...
                <div className={styles.navCta}>
                    <Button varient='color' href='/contact'>Start Planning</Button>
                </div>

                <div className={styles.navMenuIcon}>
                    <button 
                        onClick={handleClick}
                        className={styles.navMenuIconBtn}
                    >
                        <Image src="/images/menu.png" alt="Menu Icon" width={24} height={24} />
                    </button>
                </div>
            </div>
