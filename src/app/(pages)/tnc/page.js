...
function Tnc() {
    ...
    const data = [
        ...
        },
        {
            ...
            content: "Your use of the website and services is also governed by our Privacy Policy, which is incorporated by reference into this Agreement. Please review our Privacy Policy to understand our practices."
        },
        {
            title: "User Behavior",
            content: "The User agrees to use the website and services only for lawful purposes. The User shall not post or transmit through the website any material which violates or infringes the rights of others, or which is unlawful, threatening, abusive, defamatory, invasive of privacy or publicity rights, vulgar, obscene, or otherwise objectionable."
        },
        {
            title: "Forbidden Activities",
            content: "The User is prohibited from engaging in the following activities:\nUsing the website or services for any illegal purpose or in violation of any local, state, national, or international law.\nAttempting to gain unauthorized access to any portion of the website or any systems or networks connected to the website.\nUsing any device, software, or routine to interfere or attempt to interfere with the proper working of the website or any transaction conducted on the website.\nCopying, reproducing, or distributing any part of the website in any medium without H&K Holidays's prior written authorization."
        },
        {
            title: "External Links",
            content: "The website may contain links to external websites that are not operated by H&K Holidays. H&K Holidays has no control over the content of such websites and accepts no responsibility for them or for any loss or damage that may arise from your use of them."
        },
        {
            title: "Termination of Access",
            content: "H&K Holidays reserves the right, in its sole discretion, to terminate or restrict your access to all or any part of the website or services at any time, without notice, for any or no reason, and without liability."
        },
        {
            title: "Entire Agreement",
            content: "This Agreement, including any additional terms and policies referenced herein, constitutes the entire agreement between the User and H&K Holidays with respect to the use of the website and services"
        },
        {
            title: "Non-Waiver",
            content: "The failure of H&K Holidays to enforce any right or provision of this Agreement shall not constitute a waiver of such right or provision."
        },
        {
            title: "Assignment",
            content: "H&K Holidays may assign its rights and obligations under this Agreement to any party at any time without notice to the User. The User may not assign their rights or obligations under this Agreement without H&K Holidays's prior written consent."
        },
        {
            title: "Refund & Cancellation Policy",
            content: "In case of user's request to cancel a booking, the following cancellation fee's are applicable \n - **Custom Itineraries:** Once the itinerary planning fee is paid, it is non-refundable.\n- **Travel Bookings:** Refunds for hotels, flights, and activities are subject to the cancellation policies of our partner providers which will be informed at the time of travel bookings. We will facilitate the process but cannot guarantee refunds beyond those terms.\n- **Refund Timeline:** Eligible refunds, if any, will be processed within 7–14 business days.\n- **Cancellation Requests:** All requests must be submitted in writing to hi@traveltalor.in"
        },
        {
            title: "Contact Details",
            content: "If you have any questions about this Agreement or the services, please contact us at hi@traveltailor.in.\n\nBy using our services, you agree to be bound by the terms and conditions set forth above. If you do not agree with any of these terms, please do not use our services."
        }
